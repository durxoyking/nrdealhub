...
import { Eye, EyeOff, Lock, Mail, Tag, User } from "lucide-react";
    ...
    <main className="flex min-h-screen items-center justify-center bg-gradient-to-br from-white via-[#eef8f0] to-white px-4 py-10">
      <div className="w-full max-w-md rounded-[2rem] border border-[#e6eee8] bg-white p-8 shadow-2xl">
        ...
        <div className="mb-8 text-center">
          <h2 className="text-3xl font-black text-[#14202a]">Create Account</h2>
          <p className="mt-2 text-[#5f6b76]">Register to access your dashboard.</p>
        </div>
        ...
        <form onSubmit={handleRegister} className="space-y-5">
          <div>
            <label className="mb-2 block text-sm font-bold text-[#14202a]">Full Name</label>
            <div className="flex items-center rounded-xl border border-[#e6eee8] bg-[#f7fbf8] px-4">
              <User size={20} className="text-[#2f9632]" />
              <input
                type="text"
                required
                value={name}
        ...
        <p className="mt-6 text-center text-sm text-[#5f6b76]">
          ...
          <Link href="/login" className="font-bold text-[#2f9632] hover:underline">
            Login
          </Link>
        </p>
